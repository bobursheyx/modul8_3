...
class ProductAttribute(models.Model):
    product = models.ForeignKey('uzum.Product', on_delete=models.CASCADE)
    key = models.ForeignKey('uzum.AttributeKey', on_delete=models.CASCADE)
    value = models.ForeignKey('uzum.AttributeValue', on_delete=models.CASCADE)
